...
```
いつもお世話になっております。
ヤスマサ（@yasumasa_55）と申します。

ニコニコ生放送の API を使用させていただきたく、ご連絡いたしました。

私は現在、ニコニコ生放送のランキングサイトを作成しております。
その際に、是非ニコニコ生放送の API を使用させていただければと思っております。

ご検討いただけますと幸いでございます。

まだ公開はできておりませんが、下記 github リポジトリで開発をしています。
```
